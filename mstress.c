// TSAN_OPTIONS="suppressions=../tsan_suppressions.txt" ./main-tsan 3 50 1
// python3 ../../script/memstat.py ./mstress 100 50 10  --interval 0.5 --output ./output.csv
...
static void *atomic_exchange_ptr(volatile void **p, void *newval)
{
    return atomic_exchange_explicit((volatile _Atomic(void *) *)p, newval, memory_order_acq_rel);
}
